...
/*get block distributed-block-topic and verify it, save new hash locally, if validating fail, log the block*/
...
public class VerifyBlock {
	public static String blockVerify(String block, String lprevioushash) throws IOException, NoSuchAlgorithmException{
		...
		/*System.out.println("block hash:" + bhash);
		System.out.println("block prehash:" + bpreviousHash);
		System.out.println("block sourcedata:" + bsourceData);
		System.out.println("local timestamp:" + btimeStamp);*/
		//initiat a new calculated prehash in verify-process
		String lhash = null;

		//prepare the data to calculate hash
        ...
        lhash = sb.toString();
		//verify hash and write new hash to local ledger
